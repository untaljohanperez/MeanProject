...
$scope.newProcess = { process: null, processingTime: null};
	...
	$scope.sendProcess = function(){
		...
		var newProcess = new Model.Process($scope.processList.length + 1,$scope.newProcess.process, $scope.newProcess.processingTime, $scope.newProcess.processingTime, readyStatus);
